...
const Home = (props) => {
  ...
  const moveBai4 = () => props.navigation.navigate("Bai4")
  const moveBai5 = () => props.navigation.navigate("Bai5")
  const moveBai6 = () => props.navigation.navigate("Bai6")
  const moveBai7 = () => props.navigation.navigate("Bai7")

  return (
    <LinearGradient
      colors={['rgba(255, 255, 255, 0)', 'rgba(209, 244, 246, 1)', 'rgba(229, 244, 245, 1)', 'rgba(0, 204, 249, 1)']}
      style={styles.container}>
      <Text style={[styles.title1, { textAlign: 'center' }]}>Thực hành tuần 8 LTTBDD</Text>
      ...
      <View style={{marginTop:150}}>
        ...
        <View style={{}}>
          <TouchableOpacity style={styles.button} onPress={moveBai4}>
            <Text>Bai 4</Text>
          </TouchableOpacity>
        </View>
        <View style={{}}>
          <TouchableOpacity style={styles.button} onPress={moveBai5}>
            <Text>Bai 5</Text>
          </TouchableOpacity>
        </View>
        <View style={{}}>
          <TouchableOpacity style={styles.button} onPress={moveBai6}>
            <Text>Bai 6</Text>
          </TouchableOpacity>
        </View>
        <View style={{}}>
          <TouchableOpacity style={styles.button} onPress={moveBai7}>
            <Text>Bai 7</Text>
          </TouchableOpacity>
        </View>
      </View>
